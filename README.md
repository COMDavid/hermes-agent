...
<tr><td><b>Desktop Application 🆕</b></td><td>Native desktop app built with <a href="https://tauri.app">Tauri</a>. Cross-platform support (Windows, macOS, Linux), real-time agent control, and modern UI. See <a href="web/TAURI_README.md">Desktop App Docs</a>.</td></tr>
...
Hermes Agent now includes a native desktop application built with [Tauri](https://tauri.app)!
...
📖 **[Desktop App Documentation →](web/TAURI_README.md)**
