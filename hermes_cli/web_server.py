...
_BUILTIN_DASHBOARD_THEMES = [
    {"name": "default",       "label": "Focus Dark",          "description": "Quiet dark workspace with reduced visual noise"},
    {"name": "default-large", "label": "Focus Dark (Large)",  "description": "Focus Dark with bigger fonts and roomier spacing"},
